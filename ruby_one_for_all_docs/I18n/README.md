...
E.g. when a lookup for the key :"foo.bar.baz" does not yield a result then the
...
I18n translation metadata is useful when you want to access information about
